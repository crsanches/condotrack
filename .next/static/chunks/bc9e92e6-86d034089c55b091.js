"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[358],{5002:function(e,t,n){n.d(t,{EK:function(){return P},ET:function(){return sA},IO:function(){return si},JU:function(){return iL},PL:function(){return sE},QT:function(){return sw},Xo:function(){return su},ad:function(){return iF},ar:function(){return sa},cf:function(){return sS},hJ:function(){return ix},oe:function(){return sC},pl:function(){return sT},r7:function(){return sI}});var r,i,s,a,o=n(9279),l=n(2680),u=n(9053),h=n(3943),c=n(6552),d=n(4575);n(357);var f=n(6300).Buffer;let m="@firebase/firestore";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class i${constructor(e,t){if(!isFinite(e)||e<-90||e>90)throw new A(C.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(t)||t<-180||t>180)throw new A(C.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+t);this._lat=e,this._long=t}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}toJSON(){return{latitude:this._lat,longitude:this._long}}_compareTo(e){return O(this._lat,e._lat)||O(this._long,e._long)}}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function sw(e){e=iS(e,iD);let t=iS(e.firestore,iO);return(function(e,t,n={}){let r=new S;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,n,r,i){let s=new id({next:o=>{s.Za(),t.enqueueAndForget(()=>rq(e,a));let l=o.docs.has(n);!l&&o.fromCache?i.reject(new A(C.UNAVAILABLE,"Failed to get document because the client is offline.")):l&&o.fromCache&&r&&"server"===r.source?i.reject(new A(C.UNAVAILABLE,'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')):i.resolve(o)},error:e=>i.reject(e)}),a=new rK(e5(n.path),s,{includeMetadataChanges:!0,_a:!0});return rU(e,a)})(await iw(e),e.asyncQueue,t,n,r)),r.promise})(iP(t),e._key).then(n=>sk(t,e,n))}class s_ extends sf{constructor(e){super(),this.firestore=e}convertBytes(e){return new iU(e)}convertReference(e){let t=this.convertDocumentKey(e,this.firestore._databaseId);return new iD(this.firestore,null,t)}}function sE(e){e=iS(e,ib);let t=iS(e.firestore,iO),n=iP(t),r=new s_(t);return st(e._query),(function(e,t,n={}){let r=new S;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,n,r,i){let s=new id({next:n=>{s.Za(),t.enqueueAndForget(()=>rq(e,a)),n.fromCache&&"server"===r.source?i.reject(new A(C.UNAVAILABLE,'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')):i.resolve(n)},error:e=>i.reject(e)}),a=new rK(n,s,{includeMetadataChanges:!0,_a:!0});return rU(e,a)})(await iw(e),e.asyncQueue,t,n,r)),r.promise})(n,e._query).then(n=>new sv(t,r,e,n))}function sT(e,t,n){e=iS(e,iD);let r=iS(e.firestore,iO),i=sm(e.converter,t,n);return sN(r,[iX(iY(r),"setDoc",e._key,i,null!==e.converter,n).toMutation(e._key,tx.none())])}function sI(e,t,n,...r){e=iS(e,iD);let i=iS(e.firestore,iO),s=iY(i);return sN(i,[("string"==typeof(t=(0,h.m9)(t))||t instanceof iq?function(e,t,n,r,i,s){let a=e.Qu(1,t,n),o=[i3(t,r,n)],l=[i];if(s.length%2!=0)throw new A(C.INVALID_ARGUMENT,`Function ${t}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let e=0;e<s.length;e+=2)o.push(i3(t,s[e])),l.push(s[e+1]);let u=[],c=eO.empty();for(let e=o.length-1;e>=0;--e)if(!i5(u,o[e])){let t=o[e],n=l[e];n=(0,h.m9)(n);let r=a.Nu(t);if(n instanceof iJ)u.push(t);else{let e=iZ(n,r);null!=e&&(u.push(t),c.set(t,e))}}return new iG(c,new eo(u),a.fieldTransforms)}(s,"updateDoc",e._key,t,n,r):function(e,t,n,r){let i=e.Qu(1,t,n);i2("Data must be an object, but it was:",i,r);let s=[],a=eO.empty();return ee(r,(e,r)=>{let o=i9(t,e,n);r=(0,h.m9)(r);let l=i.Nu(o);if(r instanceof iJ)s.push(o);else{let e=iZ(r,l);null!=e&&(s.push(o),a.set(o,e))}}),new iG(a,new eo(s),i.fieldTransforms)}(s,"updateDoc",e._key,t)).toMutation(e._key,tx.exists(!0))])}function sC(e){return sN(iS(e.firestore,iO),[new tz(e._key,tx.none())])}function sA(e,t){let n=iS(e.firestore,iO),r=iL(e),i=sm(e.converter,t);return sN(n,[iX(iY(e.firestore),"addDoc",r._key,i,null!==e.converter,{}).toMutation(r._key,tx.exists(!1))]).then(()=>r)}function sS(e,...t){var n,r,i;let s,a,o;e=(0,h.m9)(e);let l={includeMetadataChanges:!1,source:"default"},u=0;"object"!=typeof t[0]||iM(t[u])||(l=t[u],u++);let c={includeMetadataChanges:l.includeMetadataChanges,source:l.source};if(iM(t[u])){let e=t[u];t[u]=null===(n=e.next)||void 0===n?void 0:n.bind(e),t[u+1]=null===(r=e.error)||void 0===r?void 0:r.bind(e),t[u+2]=null===(i=e.complete)||void 0===i?void 0:i.bind(e)}if(e instanceof iD)a=iS(e.firestore,iO),o=e5(e._key.path),s={next:n=>{t[u]&&t[u](sk(a,e,n))},error:t[u+1],complete:t[u+2]};else{let n=iS(e,ib);a=iS(n.firestore,iO),o=n._query;let r=new s_(a);s={next:e=>{t[u]&&t[u](new sv(a,r,n,e))},error:t[u+1],complete:t[u+2]},st(e._query)}return function(e,t,n,r){let i=new id(r),s=new rK(t,i,n);return e.asyncQueue.enqueueAndForget(async()=>rU(await iw(e),s)),()=>{i.Za(),e.asyncQueue.enqueueAndForget(async()=>rq(await iw(e),s))}}(iP(a),o,c,s)}function sN(e,t){return function(e,t){let n=new S;return e.asyncQueue.enqueueAndForget(async()=>r3(await iv(e).then(e=>e.syncEngine),t,n)),n.promise}(iP(e),t)}function sk(e,t,n){let r=n.docs.get(t._key),i=new s_(e);return new sg(e,i,t._key,r,new sp(n.hasPendingWrites,n.fromCache),t.converter)}new WeakMap,function(e=!0){g=o.Jn,(0,o.Xd)(new l.wA("firestore",(t,{instanceIdentifier:n,options:r})=>{let i=t.getProvider("app").getImmediate(),s=new iO(new D(t.getProvider("auth-internal")),new V(t.getProvider("app-check-internal")),function(e,t){if(!Object.prototype.hasOwnProperty.apply(e.options,["projectId"]))throw new A(C.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new ev(e.options.projectId,t)}(i,n),i);return r=Object.assign({useFetchStreams:e},r),s._setSettings(r),s},"PUBLIC").setMultipleInstances(!0)),(0,o.KN)(m,"4.7.3",void 0),(0,o.KN)(m,"4.7.3","esm2017")}()}}]);