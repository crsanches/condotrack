...
import { createTarefa, getAllResponsaveis } from '@/lib/firestore'
import { Timestamp } from 'firebase/firestore'
import type { Periodicidade, Responsavel } from '@/types'
...
export default function NovaTarefaPage() {
  ...
  return (
    <>
      <Header title="Nova tarefa" showBack backHref="/tarefas" />
      ...
      <div className="min-h-screen bg-gray-50 pb-36">
        ...
        <div className="px-4 pt-4">
          <div className="bg-gradient-to-r from-[#1a2744] to-[#2d4570] rounded-3xl p-5 text-white shadow-lg">
            ...
            <h1 className="text-2xl font-bold mt-2">Nova tarefa periódica</h1>
            <p className="text-sm text-white/80 mt-2">
              Defina título, periodicidade e responsável padrão.
            </p>
          </div>
        </div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                placeholder="Ex: Testar portas de incêndio"
              />
            </div>
